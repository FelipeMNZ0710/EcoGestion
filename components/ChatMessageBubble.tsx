      ...
      case 'link':
        return (
          <a
            ...
            className="block my-2 bg-secondary/20 text-secondary font-semibold p-3 rounded-lg hover:bg-secondary/30 transition-colors underline"
          >
            {block.title} &rarr;
          </a>
        );
    ...
    <div className={`${wrapperClasses} ${animationClass}`}>
      ...
      <div className={`max-w-lg`}>
        ...
        {message.isFallback && !isUser && (
            <p className="text-xs text-amber-600 mt-1.5 px-2 flex items-center space-x-1">
