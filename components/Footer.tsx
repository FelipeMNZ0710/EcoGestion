                ...
                <div className="footer-grid">
                    ...
                    <div>
                        ...
                        <div className="text-sm space-y-3">
                            <p>Av. 25 de Mayo 555,<br/>Formosa, Argentina</p>
                            <p>contacto@ecogestion.com</p>
                            <p>+54 370 4123456</p>
                        </div>
                    </div>
                </div>
