                ...
                <div className="modern-card overflow-hidden grid md:grid-cols-5 animate-fade-in-up" style={{ animationDelay: '200ms' }}>
                    ...
                    <aside className="md:col-span-2 bg-slate-800 text-white p-8">
                        ...
                        <div className="space-y-6">
                            {/* Email, Teléfono, Dirección... */}
                             <div className="flex items-start space-x-3">
                                ...
                                <div><h3 className="font-semibold text-slate-200">Email</h3><a href="mailto:contacto@ecogestion.com" className="hover:underline text-secondary">contacto@ecogestion.com</a></div>
                            </div>
                            <div className="flex items-start space-x-3">
                        ...
                        <div className="mt-8 pt-6 border-t border-white/20">
                             ...
                             <div className="flex space-x-4">
                                ...
                                <a href="#" className="text-slate-300 hover:text-secondary"><svg className="w-6 h-6" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor"><title>X</title><path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932ZM17.61 20.644h2.039L6.486 3.24H4.298Z"/></svg></a>
                    ...
                    <section className="md:col-span-3 p-8">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div><label htmlFor="subject" className="form-label">Asunto</label><input type="text" id="subject" name="subject" value={formState.subject} onChange={handleInputChange} className="form-input" required /></div>
