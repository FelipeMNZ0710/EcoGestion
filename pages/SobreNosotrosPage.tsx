...
const SobreNosotrosPage: React.FC = () => {
    const owners = [
        ...
        {
            name: "Ana García",
            role: "Co-Fundadora y Directora de Comunidad",
            description: "Con un fuerte compromiso social y ambiental, Ana es el corazón de la comunidad EcoGestión. Se encarga de la creación de contenido, la organización de eventos y la comunicación en redes sociales, fomentando un movimiento positivo y participativo en Formosa.",
