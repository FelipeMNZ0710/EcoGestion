...
export const allAchievements: Omit<Achievement, 'unlocked'>[] = [
    ...
    { id: '79', name: 'Curioso', description: 'Usa el identificador de IA por primera vez.', icon: '📸', unlockCondition: { type: 'stat', stat: 'messagesSent', value: 2 } }, // Simulado
    { id: '80', name: 'Fotógrafo Ecológico', description: 'Usa el identificador de IA 5 veces.', icon: '📷', unlockCondition: { type: 'stat', stat: 'messagesSent', value: 6 } }, // Simulado
    { id: '81', name: 'Detective de Residuos', description: 'Usa el identificador de IA 10 veces.', icon: '🕵️‍♀️', unlockCondition: { type: 'stat', stat: 'messagesSent', value: 11 } }, // Simulado
