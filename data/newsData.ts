...
export const initialNews: NewsArticle[] = [
    {
        ...
        content: [
            { type: 'text', text: 'En un evento celebrado esta mañana, autoridades locales y provinciales inauguraron la nueva Planta de Clasificación de Residuos, un proyecto clave para la estrategia de gestión ambiental de Formosa. Se espera que la planta procese hasta 50 toneladas de residuos diarios, separando plásticos, cartón, vidrio y metales para su posterior reciclaje.' },
            { type: 'image', imageUrl: 'https://images.unsplash.com/photo-1599667633245-02194c7722b4?q=80&w=600&auto=format&fit=crop', mimeType: 'image/jpeg' },
            { type: 'text', text: 'El intendente destacó que "esta planta no solo reduce el impacto ambiental de nuestros residuos, sino que también genera nuevos puestos de trabajo y fomenta una economía circular en la región".' },
            { type: 'list', items: ['Capacidad de 50 toneladas/día.', 'Creación de 30 empleos directos.', 'Tecnología de clasificación óptica.', 'Punto de recepción para residuos electrónicos.'] }
        ],
        featured: true,
    },
    {
        ...
        content: [
            { type: 'text', text: 'El plástico de un solo uso es uno de los mayores contaminantes de nuestro planeta. Reducir su consumo es más fácil de lo que piensas. Aquí te dejamos cinco consejos prácticos:' },
            { type: 'list', items: [
    ...
    },
    {
        ...
        content: [
            { type: 'text', text: 'Convocados por EcoGestión y otras organizaciones locales, más de 200 vecinos de todas las edades se dieron cita el sábado por la mañana para limpiar un tramo de 2 kilómetros de la Costanera. En total, se recolectaron más de 800 kg de residuos, de los cuales una gran parte fue separada para su reciclaje.' },
            { type: 'text', text: '"Es increíble ver lo que podemos lograr cuando trabajamos juntos", comentó una de las voluntarias. "Ver la costa limpia nos da esperanza y nos motiva a seguir cuidando lo nuestro".' }
        ],
        featured: false,
    },
    {
        ...
        content: [
            { type: 'text', text: '¿Sabías que casi el 50% de la basura que generamos en casa es orgánica? El compostaje es la solución perfecta para estos residuos. No solo reduces tu basura, sino que creas un fertilizante natural de alta calidad.' },
            { type: 'list', items: [
